package com.jieli.otasdk_java.tool.snapdrop;
...
import com.jieli.otasdk_java.activities.SnapDropActivity;
...
public class JavaScriptInterface {
    ...
    public JavaScriptInterface(final SnapDropActivity context) {
...
/**
    ...
    public void updateLastOnlineTime() {
        context.prefs.edit().putLong("last_server_connection"/*context.getString(R.string.pref_last_server_connection)*/, System.currentTimeMillis()).apply();
    }
