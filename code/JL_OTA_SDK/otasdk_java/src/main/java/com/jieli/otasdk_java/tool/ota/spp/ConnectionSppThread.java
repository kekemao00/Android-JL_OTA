...
public class ConnectionSppThread extends Thread {
    ...
    public ConnectionSppThread(BluetoothDevice device, UUID sppUUID, OnConnectSppListener listener) {
    ...
    public synchronized void run() {
        ...
        JL_Log.e(TAG, "-ConnectionSppThread- connect device : " + BluetoothUtil.printBtDeviceInfo(mDevice) + ", uuid = " + mSppUUID);
        try {
